...
namespace DtoSrcGen
{
    internal abstract class GeneratorBase
    {
        ...
        protected INamedTypeSymbol TargetType { get; set; }
        ...
        public virtual void Pre(SourceProductionContext context, LanguageVersion currentLanguageVersion, INamedTypeSymbol symbol)
        {
        ...
        public virtual void AppendConstructors(SourceProductionContext context, StringBuilder sb, INamedTypeSymbol symbol, int indent)
        {
        ...
        public virtual void AppendProperties(SourceProductionContext context, StringBuilder sb, INamedTypeSymbol symbol, int indent)
        {
            if (!_languageIsSupported)
                return;
        ...
        protected virtual IReadOnlyList<SymbolWithAlias> GetMembers(SourceProductionContext context, INamedTypeSymbol symbol)
        {
            return new List<SymbolWithAlias>();
        }
