...
namespace DtoSrcGen
{
    internal class OmitGenerator : IAttributeGenerator
    {
        public string AttributeName => "OmitAttribute";

        public string AttributeNameWithNamespace => "DtoSrcGen.OmitAttribute";
        ...
        public void Pre(SourceProductionContext context, LanguageVersion currentLanguageVersion, INamedTypeSymbol symbol)
        {
            ...
            Members = members.Where(x
                => x.Kind is SymbolKind.Property or SymbolKind.Field
                   ...
                   && !x.IsStatic
                   && !properties.Contains(x.Name)).ToList();
        }
